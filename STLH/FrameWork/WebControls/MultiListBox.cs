...
namespace FrameWork.WebControls
{
    ...
    public class MultiListBox : CompositeControl, IPostBackDataHandler
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            sb.AppendFormat("var {1}=new MultiListBox(document.getElementById('{1}_firstListBox'),document.getElementById('{1}_secondListBox'),'{1}_');{0}", Environment.NewLine, this.ClientID);
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            //显示FirstListBox列表框
            RenderOptionsContents(writer, FirstListBox, "firstListBox", string.Format("{0}.transferRight(this)", this.ClientID));
            writer.RenderEndTag();
            ...
            writer.RenderBeginTag(HtmlTextWriterTag.Td);
            //显示SecondListBox列表框
            RenderOptionsContents(writer, SecondListBox, "secondListBox", string.Format("{0}.transferLeft(this)", this.ClientID));
            writer.RenderEndTag();
            writer.RenderEndTag();
        ...
        protected void RenderMultiIcon(HtmlTextWriter writer)
        {
            ...
            RenderImageContents(writer, "moveAllRight.gif", string.Format("{0}.transferAllLeft();", this.ClientID), "_AllRight");//全部右移
            RenderImageContents(writer, "moveRight.gif", string.Format("{0}.transferRight();", this.ClientID), "_Right");
            RenderImageContents(writer, "moveLeft.gif", string.Format("{0}.transferLeft();", this.ClientID), "_Left");
            RenderImageContents(writer, "moveAllLeft.gif", string.Format("{0}.transferAllRight();", this.ClientID), "_AllLeft");
            writer.RenderEndTag();
        }
