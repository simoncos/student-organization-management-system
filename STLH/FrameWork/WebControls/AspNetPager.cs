...
namespace FrameWork.WebControls
{
    ...
    public class AspNetPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        // by lizhiqiang add 2010-8-31
        /// <summary>
        /// 在url前面增加字符
        /// </summary>
        [Browsable(true), Themeable(false), ANPDescription("desc_FirstUrlAddChar"), ANPDefaultValue("def_FirstUrlAddChar"), Category("Data")]
        public string FirstUrlAddChar
        {
            get
            {
                object obj = ViewState["FirstUrlAddChar"];
                if (null == obj)
                {
                    return "";
                }
            ...
            set
            {
                ViewState["FirstUrlAddChar"] = value;
            } 
        }
        ...
        private string BuildUrlString(NameValueCollection col)
        {
            ...
            if (urlParams == null || urlParams.Count <= 0)
            {
                ...
                return FirstUrlAddChar+String.Concat(Path.GetFileName(currentUrl), "?", tempstr.Substring(1));
            }
            ...
            return FirstUrlAddChar+String.Concat(Path.GetFileName(currentUrl), "?", sb.ToString().Substring(1));
        }
