...
namespace FrameWork.WebControls
{
    ...
    public class FieldWebControls : WebControl
    {
        ...
        private string _F_Value_key = "ValueID";
        ...
        /// 应用字段Value值使用字段名
        /// </summary>
        [Description("应用字段Value值使用字段名,UseCodeValue为true,此设置无效"), Category("数据"), DefaultValue("ValueID")]
        public string UseValue
        {
            get
            {
                object m = ViewState["F_Value_key"];
                return m == null ? _F_Value_key : m.ToString();
            }
            set
            {
                ViewState["F_Value_key"] = value;
            }
        }
        #endregion
