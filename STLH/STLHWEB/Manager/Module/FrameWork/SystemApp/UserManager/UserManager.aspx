<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master"
    AutoEventWireup="true" CodeBehind="UserManager.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.UserManager.UserManager" %>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    ...
                    <td class="table_none table_none_NoWidth" style="height: 28px">
                        ...
                        <asp:Label ID="U_LoginName_Value" runat="server"></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth" style="height: 28px">
                        密码
                    </td>
                    <td class="table_none table_none_NoWidth" style="height: 28px">
                        <asp:TextBox ID="U_Password" TextMode="Password" title="请输入密码~32:!" runat="server"
                            CssClass="text_input"></asp:TextBox>
                        <asp:Label ID="U_Password_Value" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_Type_Value" runat="server"></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        禁止登陆
                    </td>
                ...
                <tr>
                    ...
                    <td class="table_none table_none_NoWidth" colspan="3">
                        <FrameWorkWebControls:MultiListBox ID="MultiListBox1" runat="server" DataTextField="R_RoleName"
                            DataValueField="RoleID" SelectionMode="Multiple">
                            <FirstListBox>
                    ...
                    <td class="table_none table_none_NoWidth" colspan="3">
                    <asp:DropDownList ID="ddl_U_LoginType" runat="server">
                        <asp:ListItem Text="系统默认" Value=""></asp:ListItem>
                        <asp:ListItem Text="域认证" Value="FrameWork,FrameWork.LdapAuthentication"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:Label ID="lb_U_LoginType" runat="server"></asp:Label>
                    </td>
                    </tr>
            </table>
        </FrameWorkWebControls:TabOptionItem>
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem2" runat="server" Tab_Name="用户资料"
            Tab_Visible="False">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_UserNO_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth" rowspan="4">
                        照片
                    </td>
                    <td class="table_none table_none_NoWidth" rowspan="4">
                        <asp:Image ID="U_PhotoUrl_Value" border="0" runat="server" onclick="javascript:window.open(MaxImgUrl)"
                            Style="cursor: pointer" title="点击放大" />
                ...
                <tr>
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_CName_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_EName_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        <span id="U_GroupID_Span" runat="server">
                            <input type="hidden" runat="server" name="U_GroupID" id="U_GroupID"><input runat="server"
                                name="U_GroupID_Txt" id="U_GroupID_Txt" class="text_input" readonly>
                        ...
                        <asp:Label ID="U_GroupID_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_Sex_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        出生年月
                    </td>
                    <td class="table_none table_none_NoWidth">
                        <asp:TextBox ID="U_BirthDay" title="请输入出生年月~:date" runat="server" CssClass="text_input"
                            onfocus="javascript:HS_setDate(this);"></asp:TextBox>
                        <asp:Label ID="U_BirthDay_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        <FrameWorkWebControls:FieldWebControls ID="FieldWebControls1" runat="server" F_Key="Title"
                            Field_Name="U_Title" LineNum="2" LineNumOn="True" />
                        <asp:Label ID="U_Title_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        身份证号码
                    </td>
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_IDCard_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_HomeTel_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        手机号
                    </td>
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_MobileNo_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_CompanyMail_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        邮件地址
                    </td>
                ...
                <tr>
                    ...
                    <td class="table_none table_none_NoWidth">
                        ...
                        <asp:Label ID="U_Extension_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        到职日期
                    </td>
                    <td class="table_none table_none_NoWidth">
                        <asp:TextBox ID="U_WorkStartDate" title="请输入到职日期~:date" runat="server" CssClass="text_input"
                            onfocus="javascript:HS_setDate(this);"></asp:TextBox>
                        <asp:Label ID="U_WorkStartDate_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body table_body_NoWidth">
                    ...
                    <td class="table_none table_none_NoWidth" colspan="3">
                        <asp:TextBox ID="U_Remark" title="请输入备注说明~2000:" runat="server" Rows="5" TextMode="MultiLine"
                            CssClass="tex_input"></asp:TextBox>
                        <asp:Label ID="U_Remark_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr id="DispTr" runat="server" visible="false">
                    ...
                    <td class="table_none table_none_NoWidth">
                        <asp:Label ID="U_LastIP_Value" runat="server" Text=""></asp:Label>
                    </td>
                    <td class="table_body table_body_NoWidth">
                        最后操作时间
                    </td>
                    <td class="table_none table_none_NoWidth">
                        <asp:Label ID="U_LastDateTime_Value" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
        </FrameWorkWebControls:TabOptionItem>
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem3" runat="server" Tab_Name="个人设定">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    <td class="table_body">
                        菜单样式
                    ...
                    <asp:Label ID="MenuSink_Txt" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <asp:Label ID="TableSink_Txt" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <asp:Label ID="PageSize_Txt" runat="server"></asp:Label>
                    </td>
                </tr>                                
            </table>
        </FrameWorkWebControls:TabOptionItem>
