    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem3" runat="server" Tab_Name="登入安全设置">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <FrameWorkWebControls:TabOptionItem ID="TabOptionItem4" runat="server" Tab_Name="域认证设置">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                    ...
                    <td class="table_body">
                        启用域认证</td>
                    <td class="table_none">
                        <asp:Label ID="lb_C_Enable_Ldap" runat="server"></asp:Label>
                        <asp:DropDownList ID="ddl_C_Enable_Ldap" runat="server">
                    ...
                    <td class="table_body">
                        域认证路径</td>
                    <td class="table_none">
                        <asp:Label ID="lb_C_Ldap_Path" runat="server"></asp:Label>
                        <asp:TextBox ID="tb_C_Ldap_Path" title="请输入域认证路径~255:"  CssClass="text_input" runat="server"></asp:TextBox>
                        <br /><font color="red">请输入需要认证域的全路径。如：LDAP://xxx.com.cn/DC=xxx,DC=com,DC=cn</font>
                        </td>
                </tr>
                <tr>
                <td class="table_body">认证域</td>
                <td class="table_none">
                        <asp:Label ID="lb_C_Ldap_Domain" runat="server"></asp:Label>
                        <asp:TextBox ID="tb_C_Ldap_Domain" title="请输入认证域~255:"  CssClass="text_input" runat="server"></asp:TextBox>
                        <br /><font color="red">请输入需要认证的域名称。如：xxx.com.cn</font>
                </td>
                </tr>
