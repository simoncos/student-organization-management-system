                        ...
                        <td class="down_text">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td style="cursor:pointer;border-left:1px solid #FFFFFF;" onclick="javascript: window.top.location.href = '/LOGIN/loginOut.aspx'">&nbsp;<img src="images/logout.gif" style="margin-bottom: -3px">&nbsp;<font color="#FFFFFF">退出系统</font></td>
...
function switchSysBar(){
 ...
 function menuonmouseout(){
     ...
     if(top!=self)
    {
        top.location.href = "/Manager/default.aspx";
    }
