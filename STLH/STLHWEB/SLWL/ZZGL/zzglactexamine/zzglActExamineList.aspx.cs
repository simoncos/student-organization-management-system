...
{
    public partial class zzglActExamineList : System.Web.UI.Page
    {   
        ...
        public void bind(string conn)
        {
            ...
            foreach (zzActivityInfo z in z_zzActivityInfo_BLL.queryZzActivityInfoList("待审核"))
            {
                dt.Rows.Add(HttpUtility.UrlEncode(EncryptHandler.AsymmectricEncrypts(z.slzzId, bobPublicKey)), z.sponsorName, z.sponsorType, z.reserTimeRange, z.responsName, z.fillDate);
            }
        ...
        protected void gvw_zzglQuery_PageIndexChanged(object sender, EventArgs e)
        {
            ...
            z_zzActivityInfo_BLL.queryZzActivityInfoList("待审核");
            bind(conn);
        }
        #endregion
