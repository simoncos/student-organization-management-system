...
CodeBehind="dwjlActQueryList.aspx.cs" Inherits="STLHWEB.SLWL.DWJL.dwjlActQueryList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>对外交流活动查询</title>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    <div><h2 class="title">对外交流活动查询列表</h2><hr /></div>
 ...
 <div>  <table  style="width:878px; border:1px double #479ac7;"><tr style="border:1px double #9be8cc;"><td>
  ...
  <asp:BoundField HeaderText="序号" >
             ...
             <asp:BoundField DataField="status" HeaderText="状态" ReadOnly="true" 
                 ...
                 DataNavigateUrlFormatString="dwjlActQuery.aspx?ID={0}" Text="详细信息">
