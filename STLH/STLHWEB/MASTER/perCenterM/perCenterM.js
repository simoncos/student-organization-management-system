...
window.onload = function () {
    ...
    if (document.documentElement.clientWidth < 1110) {
        ...
        var rightmodulewidth = document.documentElement.clientWidth - 1100;
...
function size1() {
    if (document.documentElement.clientWidth < 1110) {
        ...
        Id('header').style.width = "100%";
        Id('rightmodule').style.display = "";
        var rightmodulewidth = document.documentElement.clientWidth - 1110;
        Id('rightmodule').style.width = rightmodulewidth + 10 + "px";
    }
    sameheight();
...
function showlogindetail()
{
    $("#logindetail").css({ display: "block" });
}
function hidelogindetail() {
