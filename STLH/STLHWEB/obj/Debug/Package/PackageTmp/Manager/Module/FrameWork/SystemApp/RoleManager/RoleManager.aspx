    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem4" Tab_Name="用户列表" runat="server">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr><td colspan="2">
                <input type="button" onclick="javascript:ShowDepartID();" value="增加用户" class="button_bak" />
                </td></tr>
...
function AlertMessageBox(file_name)
    {
        ...
        if (file_name != undefined) {
            //alert(file_name);
            location.href = 'RoleManager.aspx?cmd=AddUser&RoleID=<%=RoleID %>&UserIDs=' + file_name;
	        }
	         
    }
      function ShowDepartID()
        {
            showPopWin('选择要增加的用户', 'SelectRoleUserList.aspx?' + rand(10000000), 600, 400, AlertMessageBox, true, true)
        }
