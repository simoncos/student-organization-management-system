            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr id="Tr2" runat="server">
                    ...
                    <td class="table_none" style="height: 25px">
                        ...
                        <asp:TextBox ID="M_PageCode" runat="server" CssClass="text_input" title="请输入模块编码~100:!"></asp:TextBox></td>
                </tr>
                ...
                <tr id="Tr7" runat="server">
                    <td class="table_body">
                        模块说明</td>
                    <td class="table_none">
                        <asp:Label ID="M_Info_Txt" runat="server"></asp:Label>
                        <asp:TextBox ID="M_Info" runat="server" Columns="50"   CssClass="text_input" title="请输入模块说明~500:"></asp:TextBox></td>
                </tr>                
